...
const Navbar = () => {
  ...
  const isActive = (path) => pathname === path ? "active font-bold text-primary" : "";
        ...
        {session ? (
          ...
          <div className="dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full border border-gray-200">
                <img
                  ...
                  alt="User Avatar"
                  src={session.user?.imageURL || session.user?.image || "https://placehold.co/100"}
                />
              </div>
            </div>
            <ul
            ...
            >
              ...
              <li><Link href="/admin/add">Add Event</Link></li>
              <li><Link href="/admin/manage">Manage Your Event</Link></li>
